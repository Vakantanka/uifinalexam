...
function loadEvent() {
    ...
    document.getElementById("bestSellers").insertAdjacentHTML("beforeend",bestSellers.map((book, index) => 
        `<div class="card">
            <div class="bookData">
                <div class="index">${index + 1}</div>
                <div class="author">${book.sub}</div>
                <h2 class="title">${book.title}</h2>
                <div class="resume">${book.text}</div>
            </div>
            <button>
